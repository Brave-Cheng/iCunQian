...
<div class="wrap">
    <?php echo form_tag("engineeringGoods/insert?" . html_entity_decode(formGetQuery("projectType", "keywords", "applicationId", "approvalId")), "id=insertMaterial") ?>
                        ...
                        <div class="formItem">
                            ...
                            <div class="iner">
                                <select class="select" name="department" id="department">
                                    ...
                                    <?php echo objects_for_select($departments, 'getId', 'getName', $department) ?>
                                </select>
                    ...
                    <div class="tables ex_tabs">
                        <table id="list">
                            ...
                            <tbody id="tbody">
                                <tr class="1">
                                    <td>1</td>
                                    <td><input type="text" name="project_name[]" class="txt w70" value="" /></td>
                                    <td><input type="text" name="brand[]" class="txt w60" value="" /></td>
                                    <td><input type="text" name="requirement[]" class="txt w50" value="" /></td>
