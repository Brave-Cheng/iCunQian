...
abstract class BasesfGuardUserPeer {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			$c->add(DepartmentSfGuardUserPeer::SF_GUARD_USER_ID, $obj->getId());
			$affectedRows += DepartmentSfGuardUserPeer::doDelete($c, $con);

			include_once 'lib/model/UserLog.php';

						$c = new Criteria();
			
			$c->add(UserLogPeer::SF_GUARD_USER_ID, $obj->getId());
			$affectedRows += UserLogPeer::doDelete($c, $con);

			include_once 'lib/model/ProjectMember.php';

						$c = new Criteria();
			
			$c->add(ProjectMemberPeer::SF_GUARD_USER_ID, $obj->getId());
			...
			$c->add(DailyReportPeer::SF_GUARD_USER_ID, $obj->getId());
			...
			$c->add(SignInPeer::SF_GUARD_USER_ID, $obj->getId());
			$affectedRows += SignInPeer::doDelete($c, $con);

			include_once 'lib/model/News.php';

						$c = new Criteria();
			
			$c->add(NewsPeer::SF_GUARD_USER_ID, $obj->getId());
			$affectedRows += NewsPeer::doDelete($c, $con);

			include_once 'lib/model/NotificationReciver.php';

						$c = new Criteria();
			
			$c->add(NotificationReciverPeer::SF_GUARD_USER_ID, $obj->getId());
			$affectedRows += NotificationReciverPeer::doDelete($c, $con);

			include_once 'lib/model/Notification.php';

						$c = new Criteria();
			
			$c->add(NotificationPeer::SF_GUARD_USER_ID, $obj->getId());
			$affectedRows += NotificationPeer::doDelete($c, $con);

			include_once 'lib/model/ReadingHistory.php';

						$c = new Criteria();
			
			$c->add(ReadingHistoryPeer::SF_GUARD_USER_ID, $obj->getId());
			...
			$c->add(ApplicationPeer::SF_GUARD_USER_ID, $obj->getId());
			...
			$c->add(ApplicationWorkFlowPeer::SF_GUARD_USER_ID, $obj->getId());
			$affectedRows += ApplicationWorkFlowPeer::doDelete($c, $con);

			include_once 'lib/model/TitleSfGuardUser.php';

						$c = new Criteria();
			
			$c->add(TitleSfGuardUserPeer::SF_GUARD_USER_ID, $obj->getId());
			$affectedRows += TitleSfGuardUserPeer::doDelete($c, $con);
