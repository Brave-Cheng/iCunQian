...
class TitleSfGuardUserMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.TitleSfGuardUserMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('title_sf_guard_user');
		$tMap->setPhpName('TitleSfGuardUser');
