...
class ProjectHistoryMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.ProjectHistoryMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('project_history');
		$tMap->setPhpName('ProjectHistory');
