...
class EngineeringGoodsMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.EngineeringGoodsMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('engineering_goods');
		$tMap->setPhpName('EngineeringGoods');
