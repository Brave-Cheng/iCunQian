...
class DepositMembersFavoritesMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.DepositMembersFavoritesMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('deposit_members_favorites');
		$tMap->setPhpName('DepositMembersFavorites');
