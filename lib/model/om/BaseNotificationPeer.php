...
abstract class BaseNotificationPeer {
	...
	const SF_GUARD_USER_ID = 'notification.SF_GUARD_USER_ID';
	...
	const UNIQUE_KEY = 'notification.UNIQUE_KEY';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'SfGuardUserId', 'Title', 'Content', 'UniqueKey', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_COLNAME => array (NotificationPeer::ID, NotificationPeer::SF_GUARD_USER_ID, NotificationPeer::TITLE, NotificationPeer::CONTENT, NotificationPeer::UNIQUE_KEY, NotificationPeer::CREATED_AT, NotificationPeer::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'sf_guard_user_id', 'title', 'content', 'unique_key', 'created_at', 'updated_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'SfGuardUserId' => 1, 'Title' => 2, 'Content' => 3, 'UniqueKey' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (NotificationPeer::ID => 0, NotificationPeer::SF_GUARD_USER_ID => 1, NotificationPeer::TITLE => 2, NotificationPeer::CONTENT => 3, NotificationPeer::UNIQUE_KEY => 4, NotificationPeer::CREATED_AT => 5, NotificationPeer::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'sf_guard_user_id' => 1, 'title' => 2, 'content' => 3, 'unique_key' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NotificationPeer::SF_GUARD_USER_ID);

		$criteria->addSelectColumn(NotificationPeer::TITLE);

		$criteria->addSelectColumn(NotificationPeer::CONTENT);

		$criteria->addSelectColumn(NotificationPeer::UNIQUE_KEY);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(NotificationPeer::SF_GUARD_USER_ID, sfGuardUserPeer::ID);
	...
	public static function doSelectJoinsfGuardUser(Criteria $c, $con = null)
	{
		...
		$c->addJoin(NotificationPeer::SF_GUARD_USER_ID, sfGuardUserPeer::ID);
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += NotificationPeer::doOnDeleteCascade(new Criteria(), $con);
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		try {
									$con->begin();
			$affectedRows += NotificationPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
				...
				$objects = NotificationPeer::doSelect($criteria, $con);
		foreach($objects as $obj) {


			include_once 'lib/model/NotificationReciver.php';

						$c = new Criteria();
			
			$c->add(NotificationReciverPeer::NOTIFICATION_ID, $obj->getId());
			$affectedRows += NotificationReciverPeer::doDelete($c, $con);

			include_once 'lib/model/SmsQueue.php';

						$c = new Criteria();
			
			$c->add(SmsQueuePeer::NOTIFICATION_ID, $obj->getId());
			$affectedRows += SmsQueuePeer::doDelete($c, $con);

			include_once 'lib/model/ReadingHistory.php';

						$c = new Criteria();
			
			$c->add(ReadingHistoryPeer::NOTIFICATION_ID, $obj->getId());
