...
abstract class BaseTitlePeer {
	...
	const CREATED_AT = 'title.CREATED_AT';

	
	const UPDATED_AT = 'title.UPDATED_AT';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (TitlePeer::ID, TitlePeer::NAME, TitlePeer::CREATED_AT, TitlePeer::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (TitlePeer::ID => 0, TitlePeer::NAME => 1, TitlePeer::CREATED_AT => 2, TitlePeer::UPDATED_AT => 3, ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TitlePeer::CREATED_AT);

		$criteria->addSelectColumn(TitlePeer::UPDATED_AT);
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += TitlePeer::doOnDeleteCascade(new Criteria(), $con);
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		try {
									$con->begin();
			$affectedRows += TitlePeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
				...
				$objects = TitlePeer::doSelect($criteria, $con);
		foreach($objects as $obj) {
			...
			$c->add(WorkflowPeer::TITLE_ID, $obj->getId());
			...
			$c->add(TitleSfGuardUserPeer::TITLE_ID, $obj->getId());
